...
public class Ink {
  ...
  public void printStats(Warrior player, Warrior enemy, Weapon pWeapon, Weapon eWeapon, Armour pArmour, Armour eArmour) {
    ...
    System.out.printf("* Weapon: %-25sWeapon: %-25s\n", pWeapon.getWeaponType(), 
      eWeapon.getWeaponType()); /* only prints the word Weapon: without displaying weaponType. 
      I can't find the error in code. It took a lot to get it to compile and print anything without throwing errors. */
      
    System.out.printf("* Armour: %-25sArmour: %-25s\n", pArmour.getarmourType(),
    eWeapon.getWeaponType()); /* Same as above; prints only the word Armour. */
